...
import com.mycompany.galsenshop.util.JsfUtil;
import com.mycompany.galsenshop.util.PaginationHelper;
...
public class CategorieController implements Serializable {
    ...
    @EJB
    private com.mycompany.galsenshop.CategorieFacade ejbFacade;
    ...
    public Categorie getCategorie(java.lang.String id) {
